...
Config = {
	...
	MarkerType = 6,
	------------------------------------
	blips = vector3(-236.76, -1340.55, 30.9),
    garage = vector3(-184.9, -1310.8, 31.3),
	coffre = vector3(-216.43, -1318.37, 30.89),
	vestiaire = vector3(-224.09, -1320.69, 30.89),
	Boss = vector3(-206.92, -1331.53, 34.89),
	spawngarage = vector3(-180.64, -1317.11, 31.3), 	spawnheading = 356.03,
    boutiquekit = vector3(-227.7, -1328.5, 30.9),
}
